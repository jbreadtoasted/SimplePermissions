...
public class DeopCommand implements CommandExecutor {
	...
	public DeopCommand(SimplePermissions instance) {
	...
	public CommandResult execute(CommandSource src, CommandContext args) throws CommandException {
		...
		instance.setPermission(user, "*", Tristate.UNDEFINED);
		
		if (user.getPlayer().isPresent()) {
			user.getPlayer().get().sendMessage(Text.of(TextColors.GOLD, TextStyles.BOLD, "You are now deopped"));
			if (user == src) {
				return CommandResult.success();
			}
		}
		
		src.sendMessage(Text.of(TextColors.GOLD, "User ", TextColors.AQUA, user.getName(), TextColors.GOLD, " deopped"));
